  ...
  return (
    <>
      ...
      <div className="w-full">
        <img src={"/bg.png"} alt="background-image" className="w-full max-w-[400px] m-auto" />
      </div>
      <div className="w-full">
        <button className="w-4/5 max-w-[320px] h-11 m-auto flex justify-center items-center notification-button text-white text-lg font-bold" onClick={handleSendNotification}>
        Send Notification
        </button>
      </div>
    </>
